  ...
  const drawerContent = (
    <Box className="collapse-drawer-container">
      ...
      <List className="collapse-drawer-list">
        <ListItem button component={Link} to="/user/GetDocument" onClick={handleDrawerToggle}>
          <ListItemIcon>
            <Home />
          </ListItemIcon>
        ...
        <Divider />
        <ListItem button component={Link} to="/vendor/register" onClick={handleDrawerToggle}>
          <ListItemIcon>
            <RegisterIcon />
          </ListItemIcon>
        ...
        <Divider />
        <ListItem button component={Link} to="/vendor/login" onClick={handleDrawerToggle}>
          <ListItemIcon>
            <LoginIcon />
          </ListItemIcon>
