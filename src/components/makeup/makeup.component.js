import './makeup.component.css';

import makeupImage from '../../assets/images/makeOver.jpg' ;
...
export function MakeupComponent(){
...
<div className='main-back-card'>
            <img src={makeupImage} className='beauty1'></img>
                ...
                <div>
                    ...
                    <Tabs defaultActivekey="1" >
                        <TabPane tab="Overview" key="1" >
                            ...
                            makeup used to cover any imperfections of the skin. Concealer is often used for any extra coverage needed to cover blemishes or other marks.  </p>
                        ...
                        <TabPane tab="Review & Ratings" key="3" style={{ width: '400px' }}>
                            ...
                            <div className='mt-3'>
                                ...
                                &nbsp;&nbsp;
                                <span>Make up</span>
                                <p className='mt-2'>"I take fruit make over here very good experience."</p>
                                <hr></hr>
                            </div>
                            <form>
