import './faceTreatement.component.css';

import facetreatmentImage from '../../assets/images/facetreatment.webp';
...
export function FaceTreatementComponent() {
    ...
    return (
        <div className='main-back-card'>
            <img src={facetreatmentImage} className='beauty1'></img>
                            ...
                            <Tabs defaultActivekey="1">
                                <TabPane tab="Overview" key="1" >
                                    ...
                                    <p className='menu-parlour-list'>
                                        A facial is a beautifying skin treatment that cleanses pores, exfoliates dead skin cells, hydrates and moisturises the skin, and treats common skin concerns with a customised regime.  </p>
                                ...
                                <TabPane tab="Review & Ratings" key="3" style={{ width: '400px' }}>
                                    <li className='menu-item-list'>
                                        <h4 className='about'>Hantus Spa</h4>
                                    </li>
                                    <li>All Reviews</li>
                                    ...
                                    <div className='mt-3'>
                                        ...
                                        &nbsp;&nbsp;
                                        <span>Face Treatement</span>
                                        <p className='mt-2'>"I take skin treatement here very good experience."</p>
                                        <hr></hr>
                                    </div>
                                    <form>
