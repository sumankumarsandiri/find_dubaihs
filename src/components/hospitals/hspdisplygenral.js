...
import "./hspdisplygenral.css";
import genralsurgen from "../../assets/images/genralsurgen.jpg";
import {
  PersonCircle,
  Share,
  Signpost,
...
function Hspdisplygenral() {
  ...
  return (
    <div>
      <img src={genralsurgen} className="hosdisplay_1" alt="genral" />
      <div className="hosdisplay_container ">
        <h4 style={{ display: "flex" }}>
          ...
          <span className="hosdisplay_ratings" style={{ height: "12px" }}>
            <HospitalStar style={{}} />
          </span>
        </h4>
        ...
        <span>
          <OverlayTrigger trigger="click" placement="right" overlay={popover}>
            ...
            >
              <Share style={{ gap: "12px", marginright: "20px" }} />
              &nbsp; Share
            </Button>
          </OverlayTrigger>
        </span>
          ...
          <Tabs defaultActivekey="1">
            ...
            <TabPane tab="Review & Ratings" key="3" style={{ width: "400px" }}>
              ...
              <div className="mt-3">
                ...
                <p className="mt-2">"Friendly Atmosphere"</p>
                <hr></hr>
              </div>
              <form>
...
export default Hspdisplygenral;
