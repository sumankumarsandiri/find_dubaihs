...
import './hspdisplyneuro.css';
import neuros from "../../assets/images/neuros.jpg";
import {
  PersonCircle,
  Share,
  Signpost,
...
function Hspdisplyneuro() {
  ...
  return (
    <div>
    <img src={neuros} className="hosdisplay_1"></img>
    <div className="hosdisplay_container ">
      <h4>
        GenralSurgen Hospital
              ...
              <div class="row g-3">
                ...
                <div class="col-lg-6 col-sm-12 ">
                  <input
                    ...
                    className="form-control bawarchi_form_inputs"
